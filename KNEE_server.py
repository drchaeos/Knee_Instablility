...
app.mount("/static", StaticFiles(directory="knee/static"), name="static")
app.mount("/images", StaticFiles(directory="knee/images"), name="images")
...
# Jinja2 템플릿 디렉토리
templates = Jinja2Templates(directory="knee/templates")
